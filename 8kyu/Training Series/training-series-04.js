...
console.log("Array length:",getLength([4,5,67,8]))

function getFirst(arr){
    //return the first element of arr
    return arr[0]
    }
console.log("The first element:",getFirst([2,4,57,5]))

function getLast(arr){
//return the last element of arr
return arr[arr.length-1]
}
console.log("The last element:",getLast([4,5,8,9]))
...
console.log("The new array:",pushElement([2,3,4,5,6]))
...
console.log("The new array after pop:",popElement([21,33,54,65,86,91]));